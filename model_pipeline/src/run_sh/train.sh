...
TRAINING_DATA_PATH="/home/antongduy/customer-churn-prediction/data-pipeline/churn_feature_store/churn_features/feature_repo/data/processed_churn_data.parquet"
