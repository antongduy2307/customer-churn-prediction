...
usage() {
  ...
  echo
  echo "Options:"
  echo "  --model-name NAME        Model name (required)"
  echo "  --version VERSION       Model version to alias (required)"
  echo "  --alias NAME            Alias to set (e.g. staging, champion, production)"
